...
def can_find_using_where_clause_and_be_sorted
  ...
  Movie.where('release_date > 2002').sort {|m| m.release_date}
...
def can_update_using_update_method
  ...
  Movie.create(title: "Wat?").update_attribute(:title, "Wat, huh?")
...
def can_update_multiple_items_at_once
  ...
  5.times do |i|
    Movie.create(title: "Movie_#{i}", release_date: 2000+i).update_attribute(:title, "A Movie")
  end
